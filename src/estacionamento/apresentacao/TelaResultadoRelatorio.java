...
public class TelaResultadoRelatorio extends JFrame implements ActionListener {
	...
	public TelaResultadoRelatorio(TelaInicialReleatorio telaInicialReleatorio, List<Movimentacao> movimentacoes, LocalDateTime data) {
		setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
		parent = telaInicialReleatorio;
		...
		Object[][] conteudoFaturado = preencherTabela(movimentacoes);
