...
public class TelaInicialMovimentacao extends JFrame implements ActionListener {
	...
	public TelaInicialMovimentacao() {
		...
		btnEntrar
				.setIcon(new ImageIcon(TelaInicialMovimentacao.class.getResource("/recursos/Nova imagem entrada.png")));
		...
		btnSair = new JButton("");
		btnSair.setIcon(
				new ImageIcon(TelaInicialMovimentacao.class.getResource("/recursos/Nova imagem sa\u00EDda.png")));
